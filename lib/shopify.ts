...
/**
 * Geeft de omzet van een orderregel EXCLUSIEF btw, ongeacht of de winkel
 * prijzen inclusief of exclusief btw voert. Shopify's order.taxes_included
 * vertelt of item.price al btw bevat; zo ja, trekken we de btw via de
 * tax_lines van de regel eraf.
 */
